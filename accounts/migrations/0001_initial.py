    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('community_lead', 'Community Lead'), ('deputy_lead', 'Deputy Lead'), ('co_lead', 'Co-Lead'), ('member', 'General Member'), ('visitor', 'Visitor')], default='visitor', max_length=20)),
