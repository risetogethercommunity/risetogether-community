...
def profile_view(request):
    # The profile is automatically linked via request.user.profile
...
def edit_profile_view(request):
    if request.method == 'POST':
        ...
        link_formset = ProfileLinkFormSet(request.POST, queryset=ProfileLink.objects.filter(profile=request.user.profile))
        ...
        link_formset = ProfileLinkFormSet(queryset=ProfileLink.objects.filter(profile=request.user.profile))
